...
def transforma_payload(payload):
    ...
    payload = {
                    ...
                    "profissional" : {
                        "ufConsProfissional" : "PR",
                        "nomeProfissionalSolicitante" : ".",
                        "sgOrgaoProfissional" : "CRM",
